...
//    [self.view addSubview:browserNavigationBarView];
    ...
    [browserNavigationBarView setBackgroundColor:[UIColor clearColor]];
    ...
    [doneButton setFrame:CGRectMake(10, 20, 50, 30)];
    ...
    [browserNavigationBarView addSubview:doneButton];

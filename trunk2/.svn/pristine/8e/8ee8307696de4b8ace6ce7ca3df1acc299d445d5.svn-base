    ...
    [[TribeService shareInstance] addUserAttentionTribe:[CurrentAccount currentAccount].uid
                                              ...
                                              OnSuccess:^(DataModel* dataModel) {
                                                  ...
                                                  if (dataModel.code == 202) {
                                                      [messageListner RouteMessage:NOTIFICATION_BANGBANG_MYHELP withContext:nil];
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString*)reuseIdentifier
{
    ...
    if (self) {
        ...
        _attention.frame = CGRectMake(0, 0, 40, 40);
        _attention.center = CGPointMake(SCREEN_WIDTH - 10 - _attention.frame.size.width / 2, _ivLogo.center.y);
        [_attention setImage:[UIImage imageNamed:@"ic_add@3x"] forState:UIControlStateNormal];

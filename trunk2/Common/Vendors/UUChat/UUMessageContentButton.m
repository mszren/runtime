...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.second = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 30, 30)];
        ...
        _contentText = [[EmojiAndTextView alloc] init];
...
- (void)setIsMyMessage:(BOOL)isMyMessage
{
    ...
    if (isMyMessage) {
        self.backImageView.frame = CGRectMake(10, 10, 215, 210);
        self.voiceBackView.frame = CGRectMake(15, 10, 90, 35);
        ...
        self.backImageView.frame = CGRectMake(15, 8, 215, 210);
        self.voiceBackView.frame = CGRectMake(25, 10, 90, 35);
...
{
    [_contentText  assembleMessageAtIndex:contentStr withisFrom:isFrom];
}
- (void)removeContentDataText
{
    NSArray * subArray = _contentText.subviews;
    
    NSUInteger num = subArray.count;
    UIView * lview;
    for (int i = 0; i < num; i++) {
        lview = [subArray objectAtIndex:i];

...
-(void)isStatus:(NSInteger)activityStatus uiImageView:(UIImageView*)statusView{
    if (activityStatus==0) {
...
- (void)onSenderActivity:(id)sender
{
    ...
    NSDictionary* dic = @{ ACTION_Controller_Name : messageListner, ACTION_Controller_Data :@(activitymodel.activityId)};
